...
var chart = AmCharts.makeChart("geoallochart", {
  "type": "serial",
  "theme": "dark",
  "rotate": true,
  "categoryField": "year",
  ...
  "trendLines": [],
  "graphs": [{
      "balloonText": "Portfölj: <b>[[value]]%</b>",
      "fillAlphas": 0.8,
      "id": "AmGraph-1",
      "lineAlpha": 0.2,
      "title": "Income",
  ...
  "valueAxes": [{
    ...
    labelFunction: function(number, label, axis) {
      // var step = (axis.max / axis.step) - (number / axis.step) + 1;
      var percentage = (number);

      label = AmCharts.formatDataContextValue("[[percentage]]%", {
        // value: number,
