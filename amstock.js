    ...
    e.AmStockChart = e.Class({
        ...
        updateComparingData: function() {
            ...
            for (c = 0; c < a.length; c++) {
                var d = a[c];
                d.dataParsed || (this.parsingData = !0, 0 < this.processTimeout ? this.delayedParseStockData(c, d) : this.parseStockData(d,
                ...
                for (q =
                    ...
                    for (z = f; z < m; z++) {
                        ...
                        if (z == f || C >= y[p] || !y[p]) {
                            ...
                            var H;
                            for (H = 0; H < E; H++) u = A[H].toField, w = v[p], null !== r[u] && (x = Number(r[u]), w[u + "Count"] = 0, isNaN(x) || (w[u + "Open"] = x, w[u + "Sum"] = x, w[u + "High"] = x, w[u + "AbsHigh"] = x, w[u + "Low"] = x, w[u + "Close"] = x, w[u + "Count"] = 1, w[u + "Average"] =
                                x));
                            w.dataContext = B;
                            w.rawData = [];
                            w.rawData.push(B);
                            ...
                            for (w = v[p], w.rawData && w.rawData.push(B), p = 0; p < E; p++) u = A[p].toField, q == t - 1 && (w[n] = e.newDate(D, b)), null !== r[u] && (x = Number(r[u]), isNaN(x) || (isNaN(w[u + "Low"]) && (w[u + "Low"] = x), x < w[u + "Low"] && (w[u + "Low"] = x), isNaN(w[u + "High"]) && (w[u + "High"] = x), x > w[u + "High"] && (w[u +
                                "High"] = x), isNaN(w[u + "AbsHigh"]) && (w[u + "AbsHigh"] = x), Math.abs(x) > w[u + "AbsHigh"] && (w[u + "AbsHigh"] = x), w[u + "Close"] = x, F = e.getDecimals(w[u + "Sum"]), G = e.getDecimals(x), isNaN(w[u + "Sum"]) && (w[u + "Sum"] = 0), w[u + "Sum"] += x, w[u + "Sum"] = e.roundTo(w[u + "Sum"], Math.max(F, G)), w[u + "Count"]++, w[u + "Average"] = w[u + "Sum"] / w[u + "Count"]))
                    }
                }
            }
        ...
        parseEvents: function(a, b, c, d, k, g) {
            ...
            for (n = 0; n < h; n++) {
                ...
                t = p.graphs;
                m = t.length;
                for (f = 0; f < m; f++) q = t[f], q.customBulletField = "amCustomBullet" + q.id + "_" + p.id,
                    q.bulletConfigField = "amCustomBulletConfig" + q.id + "_" + p.id, q.chart = p;
            ...
            for (var y in l)
                if (l.hasOwnProperty(y))
                    for (b = l[y], h = e.extractPeriod(y), n = b.length, f = 0; f < d.length; f++) {
                        ...
                        v && (q = m.graph, p = m.panel, q && (t = "amCustomBullet" + q.id + "_" + p.id, q = "amCustomBulletConfig" + q.id +
                            ...
                            void 0 !== m.fontSize && p.fontSizes.push(m.fontSize), p.colors.push(m.color), p.values.push(m.value), p.showOnAxis.push(m.showOnAxis), p.showBullets.push(m.showBullet), p.date = new Date(m.date)))
                    }
                a.dataParsed = !0;
            this.onDataUpdated()
        },
        ...
        measurePanels: function(a) {
            ...
            if (this.div) {
                ...
                !b.vertical && (b = b.offsetHeight, c -= b + e);
                ...
                if (c != this.prevPH) {
                    ...
                    for (b = 0; b < a.length; b++)
                        if (g = a[b]) g.percentHeight =
                            g.percentHeight / d * 100, g.panelBox && (g.panelBox.style.height = Math.round(g.percentHeight * this.panelsHeight / 100) + "px");
                    this.prevPH = c
                }
            }
        },
        ...
        updatePanelsWithNewData: function() {
            ...
            if (a) {
                ...
                0 < a.dataProvider.length && (this.fixGlue(), this.zoomChart(this.startDate,
                    this.endDate))
            }
        ...
        addChartScrollbar: function() {
            ...
            if (a.enabled) {
                ...
                var l;
                d && (l = new e.AmGraph(this.theme), l.valueField = d.valueField, l.periodValue = d.periodValue, l.type = d.type, l.connect =
                    d.connect, l.minDistance = a.minDistance, b.addGraph(l));
                ...
                "bottom" == a.position ? c ? "bottom" == c.position ? k.insertBefore(l, d) : k.appendChild(l) : k.appendChild(l) :
                    c ? "top" == c.position ? k.insertBefore(l, d.nextSibling) : k.insertBefore(l, k.firstChild) : k.insertBefore(l, k.firstChild);
                b.write(l)
            }
        },
        ...
        addCursor: function(a) {
            ...
            if (b.enabled) {
                ...
                a.chartCursor && (e.copyProperties(a.chartCursor,
                    c), a.chartCursor.categoryBalloonFunction && (d = a.chartCursor.categoryBalloonFunction));
        ...
        zoomChart: function(a, b) {
            ...
            if (k && g) {
                ...
                v = e.newDate(a);
                c.extendToFullPeriod && (v.getTime() - k.getTime() < .1 * A && (v = e.resetDateToMin(a, n.period, n.count, y)), g.getTime() - b.getTime() < .1 * A && (b = e.resetDateToMin(g, n.period,
                    n.count, y), b = e.changeDate(b, n.period, n.count, !0)));
                            ...
                            if (f.valueAxis) {
                                ...
                                for (D = 0; D < B; D++) {
                                    ...
                                    if (m) {
                                        ...
                                        if (h = f.compareGraphNegativeFillAlphas) r.negativeFillAlphas =
                                            h;
                                        ...
                                        isNaN(h) || (r.bulletBorderThickness =
                                            h);
...
(function() {
    ...
    e.PeriodSelector = e.Class({
        construct: function(a) {
            ...
            this.width = 180;
            this.fromText = "Startdatum: ";
            this.toText = "Slutdatum: ";
            this.periodsText = "Tidsperiod: ";
        ...
        write: function(a) {
            ...
            if (e.ifArray(n)) {
                ...
                for (var t, c = 0; c < n.length; c++) l = n[c], t = document.createElement("input"), t.type = "button", t.value = l.label, t.period = l.period, t.count = l.count,
                    t.periodObj = l, t.className = "amChartsButton " + d + "-period-input", a && e.applyStyles(t.style, a.PeriodButton), k && (t.style.width = b.width - 1 + "px"), t.style.boxSizing = "border-box", f.appendChild(t), b.addEventListeners(t), l.button = t;
        ...
        handlePeriodChange: function(a) {
            this.selectPeriodButton((a.srcElement ?
                a.srcElement : a.target).periodObj, !1, a)
        },
        ...
        selectPeriodButton: function(a, b, c) {
            ...
            f && m && ("MAX" == g ? (h = f, n = m) : "YTD" == g ? (h = new Date, h.setMonth(0, 1), h.setHours(0, 0, 0, 0), 0 === k && h.setDate(h.getDate() - 1), n = this.lastDate) : "YYYY" == g || "MM" == g ? h ? (h = f, n = new Date(f), "YYYY" == g && (k *= 12), n.setMonth(n.getMonth() + k)) : (h =
                ...
                d.style.display = "inline"), h.getTime() > m.getTime() && (q = e.getPeriodDuration("DD", 1), h = new Date(m.getTime() - q)), h.getTime() < f.getTime() && (h = f), "YTD" == g && (a.startTime = h.getTime(), m.getFullYear() < (new Date).getFullYear() && (d.style.display = "none")), a.endTime = n.getTime(), b || (this.skipMark = !0, this.unselectButtons(), d.className = "amChartsButtonSelected " + l.classNamePrefix + "-period-input-selected", t && e.applyStyles(d.style, t.PeriodButtonSelected), a = {
                    type: "changed"
                }, a.startDate = h, a.endDate = n, a.predefinedPeriod =
                g, a.chart = this.chart, a.count = k, a.event = c, this.fire(a)))
        },
...
(function() {
    ...
    e.DataSetSelector = e.Class({
        construct: function(a) {
            ...
            this.position = "left";
            this.selectText = "Välj tidsserie:";
            this.comboBoxSelectText = "Select...";
            this.compareText = "Jämför med:";
            this.width = 170;
            this.dataProvider = [];
            this.listHeight = 150;
            this.listCheckBoxSize = 16;
        ...
        write: function(a) {
            ...
            if (0 < b.countDataSets("showInCompare") && 1 < g.length)
                if (l ? (e.addBr(a), e.addBr(a)) : (c = document.createTextNode(" "), a.appendChild(c)), c = document.createTextNode(k.langObj.compareText || b.compareText), a.appendChild(c), f = b.listCheckBoxSize, l) {
                    ...
                    h.style.height = b.listHeight + "px";
                    for (c = 0; c < g.length; c++) n = g[c], !0 === n.showInCompare && n != b.chart.mainDataSet && (d = document.createElement("div"), d.style.padding = "4px", d.style.position = "relative", d.name = "amCBContainer", d.className = k.classNamePrefix + "-compare-item-div", d.dataSet = n, d.style.height = f+3  + "px", n.compared && (d.style.backgroundColor = b.selectedBackgroundColor), h.appendChild(d), l = document.createElement("div"),
                        l.style.width = f + "px", l.style.height = f-4 + "px", l.style.position = "absolute", l.style.backgroundColor = n.color, d.appendChild(l), l = document.createElement("div"), l.style.width = "100%", l.style.position = "absolute", l.style.left = f + 10 + "px", d.appendChild(l), n = document.createTextNode(n.title), l.style.whiteSpace = "nowrap", l.style.cursor = "default", l.appendChild(n), b.addEventListeners(d));
                    e.addBr(a);
                    e.addBr(a)
                } else {
...
(function() {
    ...
    e.StackedBullet = e.Class({
        ...
        addLetter: function(a, b, c) {
            ...
            this.bullets[c] = v;
            this.showOnAxis ? (m = isNaN(this.nextAxisY) ? this.axisCoordinate : this.nextY,
                f = h * k, this.nextAxisY = m + k * d) : this.value ? (m = this.value, l.recalculateToPercents && (m = m / l.recBaseValue * 100 - 100), m = l.getCoordinate(m) - this.bulletY, f = h * k) : this.showAt ? (v = this.graphDataItem.values, l.recalculateToPercents && (v = this.graphDataItem.percents), v && (m = l.getCoordinate(v[this.showAt]) - this.bulletY, f = h * k)) : (m = this.nextY, f = h * k);
            a.translate(n, f);
            b.push(a);
            b.translate(0, m);
