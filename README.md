# Dokument som jag ändrar på:
# index2.html utgör moderarket, vilket innebär de generiska menyfunktionerna
# inital.js är tänkt att hålla centralfunktioner. Tanken var att köra inladdningen av data där direkt men det gick inte att sjösätta så den får utgöra nån slags slasktratt för olika funktioner istället
# graphs.js kommer vara där alla generiska och ickegeneriska graftyper ligger
# dark.js håller färgtemat, på sikt borde det byta namn till coin_colour.js eller ngt
# custom.css är där alla frames och grafik ligger. Inte särskilt navigerad i det arket, kommer behöva rensas på sikt.
# amstock/amchart är där alla grundfunktioner ligger för graferna. Det är källkoden och vi borde inte ändra mer än språket



####### nedan följer den grunden jag började från
# gentelella
